...
## Project Structure
    ...
    ├── testapiautosetting_112277  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_112277`
...
2. Clone this repo and `cd testapiautosetting_112277`
